...
def bulk_force_coupling(fr_bulk, fi_bulk, u, DX):
...
def bulk_force_gain(Q, power_opt, power_mech, omega_opt, fr_bulk, fi_bulk, u, DX):
    """ calculate gain due to bulk electrostriction 
        returns gain in units of  W-1 m-1 """
    coupling_bulk = bulk_force_coupling(fr_bulk, fi_bulk, u, DX)
